...
//
// Build and run this program to generate DeleteMiniakPatches.syx
//
...
int main()
{
	...
	// write out file
	//
	string	outName = "DeleteMiniakPatches1.syx";
	char Outfname[100];
	...
	// generate banks 11 ... 15 and patches 0 ... 127
	// F0 00 00 0E 26 21 bank 00 patch F7
	byte stub[6] = {0xF0, 0x00,  0x00,  0x0E,  0x26,  0x21};
	byte zero[1] = {0x00};
	byte eom[1] = {0xf7};
	byte patchByte[1];
	byte bankByte[1];	
	for (int bank = 10; bank < 15; bank++)
	{
